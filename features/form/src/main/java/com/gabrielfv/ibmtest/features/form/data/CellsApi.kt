...
class CellsApi : CellsProvider {
    ...
    override fun fetchCells(): Single<List<Cell>> = Single.just(listOf(
        Cell(0, Cell.InputType.TEXT, "Nome", Cell.DataType.TEXT, false, 35.0, null, true),
        Cell(1, Cell.InputType.TEXT, "Email", Cell.DataType.EMAIL, false, 35.0, null, true),
        Cell(2, Cell.InputType.TEXT, "Telefone", Cell.DataType.PHONE, false, 35.0, null, true),
